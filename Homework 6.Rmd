...
This plot shows me that I have a bad model. It is very skewed and lots of uncontrolled confounding. 
...
```{r}
birthweight_fit_2 = lm(bwt ~ bhead + blength + babysex, data = birthweight_data_clean) %>% 
  broom::tidy()
```
